...
console.log('PASS: changes limited to approved header restoration/resize code, tests, docs and prior Phase 4 work; listener source/tests, Ask, capture, repositories and provider settings unchanged.');
