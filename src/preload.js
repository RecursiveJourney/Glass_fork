...
contextBridge.exposeInMainWorld('api', {
  ...
  settingsView: {
    ...
    getMcpSettings: () => ipcRenderer.invoke('mcp:settings'),
    saveMcpSettings: data => ipcRenderer.invoke('mcp:save', data),
    testMcpConnection: data => ipcRenderer.invoke('mcp:test', data),
    newMcpIdentity: () => ipcRenderer.invoke('mcp:new-identity'),
    approveMcpKnowledge: data => ipcRenderer.invoke('mcp:approve-knowledge', data),
